...
/* Calls non-realtime update state machine. Must be called regularly (although it is not time-critical)
   in the main loop of the program if aux clocks or external reference are used in the design. */
void spll_update();
